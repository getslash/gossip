...
# pylint: disable=bad-continuation,redefined-builtin,multiple-imports,unused-import,import-error
import sys, os
...
project = u'gossip'
copyright = u'2014-2023, Rotem Yaari'
...
version = release = distribution('gossip').version
