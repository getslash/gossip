# -*- coding: utf-8 -*-
#
# capnhook documentation build configuration file, created by
...
latex_documents = [
  ('index', 'capnhook.tex', u'capnhook Documentation',
...
man_pages = [
    ('index', 'capnhook', u'capnhook Documentation',
     [u'Rotem Yaari'], 1)
]
...
texinfo_documents = [
  ('index', 'capnhook', u'capnhook Documentation',
   u'Rotem Yaari', 'capnhook', 'One line description of project.',
   'Miscellaneous'),
]
